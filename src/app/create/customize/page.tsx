...
export default function CustomizePage() {
  ...
  // 세션에서 템플릿 로드
  useEffect(() => {
    const t = sessionStorage.getItem("artpage_create_template");
    if (!t) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // 세션에서 이미지 URL 가져오기
      const imagesRaw = sessionStorage.getItem("artpage_create_images");
      ...
      if (result.success) {
        ...
        // 세션 정리
        sessionStorage.removeItem("artpage_create_images");
        sessionStorage.removeItem("artpage_create_analysis");
        sessionStorage.removeItem("artpage_create_template");
