...
export default async function PortfolioPage({
  ...
  const accentColor = isArthyun ? "text-blue-600" : "text-blue-600";
    ...
    <div className="min-h-screen bg-white pt-32 pb-20">
      <div className="max-w-screen-2xl mx-auto px-6">
        <div className="mb-16 border-b border-black pb-8 flex flex-col md:flex-row justify-between items-end gap-6">
          <div>
            <span className={`text-xs font-bold tracking-[0.2em] ${accentColor} block mb-2`}>
